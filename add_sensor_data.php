...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql = "INSERT INTO sensor (District, year, humidity, max_temperature, min_temperature, Installation_Date) VALUES (?, ?, ?, ?, ?, ?)";

    $stmt = $conn->prepare($sql);
    $stmt->bind_param("siiiis", $District, $year, $humidity, $max_temperature, $min_temperature, $Installation_Date);

    if ($stmt->execute() === TRUE) {
        $successMessage = "Sensor data added successfully!";
    } else {
